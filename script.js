...
const translations = {
  nl: {
    ...
    hero_title: "Ik ontwerp systemen die teams en dealers vlotter laten presteren.",
    hero_body:
      "Ik ben Motouzani: software consultant in automotive, trainer binnen BMW HQ Belux en founder van DigitalFarmers.be. Als systeemdenker help ik organisaties workflow, kwaliteit en klantimpact tegelijk versterken.",
    hero_b1: "⚡ Tech‑savvy",
    ...
    panel_body: "Workflow, quality, delivery — aligned as one system.",
    panel_m1: "clarity",
    panel_m2: "flow",
    panel_m3: "feedback",

    value_eyebrow: "GITHUB‑LEVEL CLARITY",
    value_title: "Minimalistisch, technisch, én menselijk",
    value_1_title: "Vertrouwen",
    value_1_body: "Ik vertaal complexiteit naar helderheid en richting.",
    value_2_title: "Impact",
    value_2_body: "Elke stap is meetbaar en linked aan resultaat.",
    value_3_title: "Rust",
    value_3_body: "Teams werken sneller zonder chaos.",
    ...
    role_2_body: "Processen die sneller, consistenter en schaalbaar worden.",
    role_3_title: "Entrepreneur",
    role_3_body: "Oplossingen die bedrijven echt vooruit brengen.",
  ...
  fr: {
    ...
    hero_title: "Je conçois des systèmes qui font avancer les équipes et les concessionnaires.",
    hero_body:
      "Je suis Motouzani : consultant software dans l’automobile, formateur au BMW HQ Belux et fondateur de DigitalFarmers.be. En tant que penseur système, j’améliore workflow, qualité et impact client.",
    hero_b1: "⚡ Tech‑savvy",
    ...
    panel_body: "Workflow, qualité, delivery — alignés en un seul système.",
    panel_m1: "clarté",
    panel_m2: "flux",
    panel_m3: "feedback",
    ...
    value_1_body: "Je transforme la complexité en clarté et direction.",
    value_2_title: "Impact",
    value_2_body: "Chaque étape est mesurable et liée aux résultats.",
    ...
    roles_title: "Tech‑savvy. Entrepreneur. Leader. Speaker.",
    role_1_title: "Speaker",
    role_1_body: "Une communication claire qui met les équipes en mouvement.",
    role_2_title: "Pensée système",
    role_2_body: "Des processus plus rapides, plus cohérents et scalables.",
    role_3_title: "Entrepreneur",
    role_3_body: "Des solutions qui font vraiment avancer l’entreprise.",
  ...
  en: {
    ...
    hero_eyebrow: "AUTOMOTIVE · SOFTWARE · TRAINING",
    hero_title: "I design systems that help teams and dealerships move faster.",
    hero_body:
      "I’m Motouzani: automotive software consultant, trainer at BMW HQ Belux, and founder of DigitalFarmers.be. As a systems thinker, I align workflow, quality, and customer impact.",
    hero_b1: "⚡ Tech‑savvy",
    ...
    value_2_title: "Impact",
    value_2_body: "Every step is measurable and tied to outcomes.",
    value_3_title: "Calm",
    value_3_body: "Teams move faster without chaos.",

    roles_eyebrow: "ROLE & IDENTITY",
    roles_title: "Tech‑savvy. Entrepreneur. Leader. Speaker.",
    role_1_title: "Speaker",
    role_1_body: "Clear communication that moves teams forward.",
    role_2_title: "System thinker",
    role_2_body: "Processes that become faster, consistent, and scalable.",
    role_3_title: "Entrepreneur",
    role_3_body: "Solutions that move businesses forward.",
